...
/**
 * This interface prescribes the getBroadbandData method, which returns requested data. This interface
 * is used to enable polymorphism, in part to help with testing via a 'mocked' broadband datasource.
 */
public interface BroadbandDatasource {

  /**
   * This method returns a CensusData object for the given state and county specified in the input parameters.
   *
