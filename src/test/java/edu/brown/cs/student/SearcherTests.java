...
//   */
//  @Test
//  public void testSearchWithHeaderWithResult()
//      throws IOException, FactoryFailureException, InvalidIndexException {
...
//   */
//  @Test
//  public void testSearchWithHeaderNoResult()
//      throws IOException, FactoryFailureException, InvalidIndexException {
//    FileReader reader = new FileReader("data/census/dol_ri_earnings_disparity.csv");
//    CSVParser<ArrayList<String>> parser = new CSVParser<>(new SearcherCreator(), reader);
//    CSVSearcher searcher = new CSVSearcher(parser, true);
...
//
//  /**
//   * A test to search a CSV file by column header, confirming that search does not return the
// header
...
//
//  /**
//   * A test for the getIndexFromHeader method, where the header does and does not exist, and
// testing
...
//   */
//  @Test
//  public void testGetIndexFromHeader()
//      throws IOException, FactoryFailureException, InvalidIndexException {
//    FileReader reader = new FileReader("data/census/dol_ri_earnings_disparity.csv");
//    CSVParser<ArrayList<String>> parser = new CSVParser<>(new SearcherCreator(), reader);
//    CSVSearcher searcher = new CSVSearcher(parser, true);
...
//   */
//  @Test
//  public void testSearchWithoutHeaderByIndex()
//      throws IOException, FactoryFailureException, InvalidIndexException {
...
//   */
//  @Test
//  public void testValueCaseInsensitive()
//      throws IOException, FactoryFailureException, InvalidIndexException {
//    FileReader reader = new FileReader("data/census/dol_ri_earnings_disparity.csv");
//    CSVParser<ArrayList<String>> parser = new CSVParser<>(new SearcherCreator(), reader);
//    CSVSearcher searcher = new CSVSearcher(parser, true);
...
//   */
//  @Test
//  public void testSearchByIndexWrongColumn()
//      throws IOException, FactoryFailureException, InvalidIndexException {
//    FileReader reader = new FileReader("data/census/dol_ri_earnings_disparity.csv");
//    CSVParser<ArrayList<String>> parser = new CSVParser<>(new SearcherCreator(), reader);
//    CSVSearcher searcher = new CSVSearcher(parser, true);
...
//
//  /**
//   * A test to confirm that the searcher can search for empty data-points if they wish to see
// which
...
//
//  /**
//   * A test to confirm that the searcher disregards any extra whitespace on either end of the
// search
